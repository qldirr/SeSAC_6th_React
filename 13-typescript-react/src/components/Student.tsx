...
/**
 * 'React.FC'
 * - React.FunctionComponent 리액트 함수형 컴포넌트 정의시 유용한 타입 정의 도구
 * - 'children' 자동 포함
 * : 기본적으로 'children' prop을 자동으로 포함
 * : 'children'이 필요없으면 안쓰고 직접 'props' 타입을 정의하는게 더 나음
 *
 * - why? - 지양하는 편
 * - children이 존재한다는 가정하에 사용하기 때문에 typescript를 사용하는 의미가 있나??
 * - children 의 타입을 명확하게 안해주면 typescript를 쓰는 이유가 있냐
 * - children 의 타입을 명확하게 해주면 React.FC를 뭐하러 쓰냐
 */
