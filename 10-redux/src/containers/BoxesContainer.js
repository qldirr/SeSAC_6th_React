...
export const Box4Container = () =>{
    ...
    return <Box4 number={number} onPlus={() => dispatch(plus())} onMinus={() => dispatch(minus())}/>
}

// 컨테이너 컴포넌트 & 프레젠테이셔널 컴포넌트
// 리액트 애플리케이션에서 컴포넌트를 구성하고 관리하는 두가지 주요 패턴
...
/**
 * <프레젠테이셔널 컴포넌트>
 * - 주로 UI 렌더링하는데 집중, 데이터나 상태를 처리하지 않음
 * ** 특징
 * - 상태 없음
 * - UI 전용
 * - 재사용성 = UI 의 여러 부분에서 재사용 될 수 있도록 설계
 */
/**
 * < 요약 >
